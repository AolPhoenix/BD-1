...
-msvcrt
-time
La mayoria de las libreroas deberian venir instaladas por defecto excepto,por ejemplo, clint (para lo único que se uso esta libreria fue para colorear el texto) o pyodbc (
 método de conexión python-base de datos), en caso de no tenerla instalarla por la via normal (pip install clint en la consola). Favor de corroborar que todas las librerías
estén instaladas antes de correr el programa.
