...
def read(cursor):
    ...
    if(pregunta == 1):
        ...
        print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"+colored.yellow("ID")+colored.cyan("|")+colored.yellow("Nombre del videojuego")+colored.cyan("|")+colored.yellow("Genero")+colored.cyan("|")+colored.yellow("Desarrollador")+colored.cyan("|")+colored.yellow("Publicadora")+colored.cyan("|")+colored.yellow("Fecha de publicacion")+colored.cyan("|")+colored.yellow("Exclusividad")+colored.cyan("|")+colored.yellow("Precio")+colored.cyan("|")+colored.yellow("Stock")+colored.cyan("|")+colored.yellow("En Bodega")+colored.cyan("|")+colored.yellow("Ventas locales")+colored.cyan("|")+colored.yellow("Ventas globales")+colored.cyan("|")+colored.yellow("Rating"))
